...
def display_menu():
    ...
    print(f"""╭────────────────────────────────────────────────╮""")
    print(f"""│  FRA ACCOUNTS  :   {total_accounts}                           │""")
    ...
    print(f"""╭────────────────────────────────────────────────╮""")
    print(f"""│   RPW ACCOUNTS  :    {total_accounts}                         │""")
    print(f"""│   RPW PAGES     :    {total_pages}                         │""")
    print(f"""╰────────────────────────────────────────────────╯""")
...
def main():
    ...
    while True:
        ...
        print("╭────────────────────────────────────────────────╮")
        print("│[1] ADD ACCOUNT                                 │")            
        print("│[2] AUTO REACT POST          =  [PAGE & ACCOUNT]│")
        print("│[3] AUTO COMMENT             =  [PAGE & ACCOUNT]│")
        print("│[4] AUTO FOLLOW              =  [PAGE & ACCOUNT]│")
        print("│[5] AUTO REACT TO REELS      =  [PAGE & ACCOUNT]│")
        print("│[6] AUTO REPLY COMMENT       =  [PAGE & ACCOUNT]│")
        print("│[7] AUTO GROUP JOIN          =  [PAGE & ACCOUNT]│")
        print("│[8] REACT WITH PHOTO & VIDEO =  [PAGE & ACCOUNT]│")
        print("│[9] AUTO SHARE [VIA COOKIE]  =  [PAGE & ACCOUNT]│")
        print("│[10] AUTO REACT COMMENT      =  [PAGE & ACCOUNT]│")
        print("╰────────────────────────────────────────────────╯")
        print("╭────────────────────────────────────────────────╮")
        print("│[11]EAAY GET TOKEN                              │")
        print("│[12]EAAU GET TOKEN                              │")
        print("│[13]AUTO CREATE PAGE                 [COOKIE]   │")
        print("│[14]ADD COOKIE                       [COOKIE]   │")
        print("│[15]AUTO CREATE FACEBOOK ACCOUNT                │")
        print("│[99]Start                                       │")
        print("│[16]AUTO COMMENT TO REELS =   [PAGE & ACCOUNT]  │")
        print("│[17]AUTO REACT WITH PHOTO =   [PAGE & ACCOUNT]  │")
        print("╰─ ╭─── ─────────────────────────────────────────╯")
        choice = input("   ╰─>")
